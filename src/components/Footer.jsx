              ...
              <div className="grid gap-10 mb-10 md:grid-cols-3">
                  ...
                  <div>
                      ...
                      <p className="text-sm leading-relaxed font-body text-cream-200/60">
                          La mejor panadería artesanal de Montería, Colombia. Horneado con amor desde el corazón
                          costeño.
                      </p>
                  </div>
                      ...
                      <div className="space-y-3">
                          <a
                              ...
                              <div>
                                  ...
                                  <p className="text-xs font-body text-cream-200/60">+57 301 332 5096</p>
                              </div>
                          </a>
              ...
              <div className="flex flex-col items-center justify-between gap-3 pt-6 border-t border-cream-50/10 sm:flex-row">
                  ...
                  <p className="text-xs font-body text-cream-200/40">
                      ...
                      <a
                          ...
                          target="_blank"
                          rel="noreferrer"
                          className="underline text-cream-200/60 hover:text-cream-200">
                          Carlos Tirado
                      </a>
                  </p>
              </div>
